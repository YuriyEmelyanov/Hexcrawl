...
- Концы простой реки выбираются среди внешних вершин региона. Внешняя вершина региона — это вершина гекса региона, рядом с которой есть хотя бы один гекс, не принадлежащий текущему региону. Река соединяет две случайные внешние вершины по графу рёбер hex-grid.
