...
- Простая река региона строится как путь по графу рёбер hex-grid: от случайной внешней вершины региона через случайную вершину `centralHex` к другой внешней вершине. Если у региона нет `centralHex`/фиолетовых вершин, река идёт от внешней вершины к внешней вершине.
