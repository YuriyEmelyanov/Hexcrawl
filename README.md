...
- Концы простой реки задаются boundary edges региона: первый и последний сегменты реки лежат на внешних рёбрах региона, по возможности смежных с candidate hexes.
